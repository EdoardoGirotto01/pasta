...
@pytest.mark.parametrize("filename,query,evidence,test_name,expected_lp,expected_up,normalize",[
    ...
    ("../examples/inference/credal_facts.lp", "sleep(bill)", "", "credal_facts_sleep_bill", 0.0, 0.0, False),
    ("../examples/inference/disjunction.lp", "f", "", "disjunction", 0.6, 0.8, False),
    ("../examples/inference/evidence_certain.lp", "a", "", "evidence_certain_a", 1.0, 1.0, False), 
    ("../examples/inference/graph_coloring.lp", "qr", "", "graph_coloring_qr", 0.03, 1.0, False),
    ("../examples/inference/monty_hall.lp", "win_switch", "", "monty_hall", 0.6666666666666667, 0.6666666666666667, False), 
    ...
    ("../examples/inference/transmission.lp" , "transmit(a,e)", "", "transmission_transmit_a_e", 0.15839999999999999, 0.6537600000000001, False),
