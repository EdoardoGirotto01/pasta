...
@pytest.mark.parametrize("parameters", [
    ...
    ArgumentsTest("burglary_qr", "../examples/inference/burglary.lp", "qr", 0.5, 0.5),
    ArgumentsTest("certain_fact_a_1", "../examples/inference/certain_fact_2.lp", "a(1)", 1.0, 1.0),
    ArgumentsTest("clique_in_1", "../examples/inference/clique.lp", "in(1)", 0.4666666666666667, 0.9333333333333333),
    ArgumentsTest("credal_facts_sleep_bill", "../examples/inference/credal_facts.lp", "sleep(bill)", 0.0, 0.0),
    ArgumentsTest("disjunction", "../examples/inference/disjunction.lp", "f", 0.6, 0.8),
    ArgumentsTest("evidence_certain_a", "../examples/inference/evidence_certain.lp", "a", 1.0, 1.0),
    ArgumentsTest("graph_coloring_qr", "../examples/inference/graph_coloring.lp", "qr", 0.03, 1.0),
    ArgumentsTest("monty_hall", "../examples/inference/monty_hall.lp", "win_switch", 0.6666666666666667, 0.6666666666666667),
    ArgumentsTest("multiple_ad", "../examples/inference/multiple_ad.lp", "qr", 0.0975, 0.5775),
    ...
    ArgumentsTest("transmission_transmit_a_e", "../examples/inference/transmission.lp" , "transmit(a,e)", 0.15839999999999999, 0.6537600000000001),
